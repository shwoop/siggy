...
pub enum InputAction {
    ...
    /// Mute/unmute the current conversation (optional duration in seconds from epoch)
    ...
    match cmd {
        ...
        "/mute" => {
            if arg.is_empty() {
                ...
                match parse_duration_to_seconds(&arg) {
                    Ok(seconds) => InputAction::ToggleMute(Some(seconds)),
                    Err(e) => InputAction::Unknown(e),
                }
            }
        }
...
mod tests {
    ...
    #[case("/mute 1h", InputAction::ToggleMute(Some(3600)))]
    #[case("/mute 8h", InputAction::ToggleMute(Some(28800)))]
    #[case("/mute 1d", InputAction::ToggleMute(Some(86400)))]
    #[case("/mute 1w", InputAction::ToggleMute(Some(604800)))]
